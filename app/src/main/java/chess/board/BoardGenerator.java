...
public class BoardGenerator {
    public static Position[][] createBoard(GameMode mode){
        switch (mode){
            ...
            case DISPLACED -> {
                return generateDisplacedBoard();
            }
            case FISCHER_RANDOM -> {
                return generateFischerRandomBoard();
            }
            case RETIRED -> {
                return generateRetiredBoard();
            }
            default -> {
    ...
    private static Position[][] generateDisplacedBoard(){
        return new Position[][]{
    ...
    private static Position[][] generateFischerRandomBoard(){
        return new Position[][]{
    ...
    private static Position[][] generateRetiredBoard(){
        return new Position[][]{
